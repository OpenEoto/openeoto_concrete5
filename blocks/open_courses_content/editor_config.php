...
<?Php
// BY MA:
// Edited for Open Courses
// thanks to: https://gist.github.com/aarongustafson/551339#file-tinymce-config-html5-js-L9 
?>
    extended_valid_elements : 'iframe[src|width|height|name|align],' + 'video[autoplay|class|controls|dir<ltr?rtl|id|lang|loop|onclick|ondblclick|onkeydown|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover|onmouseup|preload|poster|src|style|title|width],' + 'audio[autoplay|class|controls|dir<ltr?rtl|id|lang|loop|onclick|ondblclick|onkeydown|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover|onmouseup|preload|src|style|title],' + 'source[class|dir<ltr?rtl|id|lang|onclick|ondblclick|onkeydown|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover|onmouseup|src|style|title|type]',
            forced_root_block : "",
            force_br_newlines : true,
            force_p_newlines : false
<?php
// http://stackoverflow.com/questions/17058644/remove-the-extra-p-tag-in-tinymce
// EO addition of Open Courses
?>
    });
</script>